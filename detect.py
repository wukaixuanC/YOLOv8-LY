...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='weights/YOLOv8s-LY.pt', help='training model path')
    parser.add_argument('--source', type=str, default='ultralytics/assets/far (2).jpg', help='source directory for images or videos')
